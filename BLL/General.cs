...
/*In professional programming , a programmer will never use this ID for LogBLL.AddLog(1,"Login",12); directly,
what we have to do is define all data in process table in a class*/