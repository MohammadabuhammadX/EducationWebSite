...
namespace UI.Areas.Admin.Controllers
{
    public class AdsController : BaseController
    {
        ...
        {               // First we delete , But as you know , in the folder , we have am image for each item in the ads table,So first we will delete item form the table
            string imagepath = bll.DeleteAds(ID);             // Then we will delete the image form the folder
            ...
            return Json("");                         // So for that we have to get the image name from the table , for this we user imagepath
        }
    }
}