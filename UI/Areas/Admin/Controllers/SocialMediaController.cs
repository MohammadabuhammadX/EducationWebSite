...
namespace UI.Areas.Admin.Controllers
{
    ...
    {
        SocailMediaBLL bll = new SocailMediaBLL();
        ...
        public ActionResult AddSocialMedia(SocialMediaDTO model)
        {
            ...
            else if (ModelState.IsValid)
            {
...

                {
                    ...
                    // This code will one iamge into the folder
        ...
        public JsonResult DeleteSocialMedia(int ID)     //First we will delete the item and then after that we will delete the image form the social media folder
        {
